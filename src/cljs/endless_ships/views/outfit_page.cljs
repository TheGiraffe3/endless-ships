           ...
           [:div.row
            ...
            [:div.col-md-4
             [:ul
              ...
              (render-attribute outfit :thruster-slots "thruster slots needed")
              (render-attribute outfit :steering-slots "steering slots needed")
            ...
            [:div.col-md-4
             ...
             [:ul
              ...
              (render-attribute outfit :thruster-slots "thruster slots")
              (render-attribute outfit :steering-slots "steering slots")
